                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{route('cms.partners.create')}}" class="btn btn-primary float-right"> Add Partner <i class="fas fa-plus-circle ml-2"></i> </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($partners as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{asset('uploads/partners/'.$item->image)}}" style="max-width: 100px" alt="">
                                            </td>
                                            <td>
                                                <div class="icons d-flex">
                                                    <a href="{{route('cms.partners.show', $item->id)}}">
                                                        <div class="view text-info mx-2 cursor-pointer">
                                                            <i class="fas fa-eye"></i>
                                                        </div>
                                                    </a>
                                                    <a href="{{route('cms.partners.edit', $item->id)}}">
                                                        <div class="edit text-primary mx-2 cursor-pointer">
                                                            <i class="fas fa-edit"></i>
                                                        </div>
                                                    </a>
                                                    <form action="{{route('cms.partners.destroy', $item->id)}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
