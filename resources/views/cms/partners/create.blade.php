    ...
    <section class="content px-3">
        <div class="row">
          <div class="col-md-12">
            ...
            <form action="{{ route('cms.partners.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-8 pt-4">
                            ...
                            <input type="text" required name="name" class="form-control" placeholder="Enter partner name">
                        </div>
                        <div class="col-md-8 pt-4">
                        ...
                        <div class="col-md-8 pt-4">
                            <label for="">URL</label>
                            <input type="text" required name="url" class="form-control" placeholder="Enter partner url">
                        </div>
                        <div class="col-md-8 pt-4">
