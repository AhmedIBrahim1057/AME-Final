                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{route('cms.news.create')}}" class="btn btn-primary float-right"> Add News <i class="fas fa-plus-circle ml-2"></i> </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($news as $item)
                                        <tr>
                                            ...
                                            <td>{{$item->date}}</td>
                                            <td>
                                                <img src="{{asset('uploads/news/'.$item->image)}}" style="max-width: 100px" alt="">
                                            </td>
                                            <td>
                                                <div class="icons d-flex">
                                                    <a href="{{route('cms.news.show', $item->id)}}">
