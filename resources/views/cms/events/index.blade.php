                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{route('cms.events.create')}}" class="btn btn-primary float-right"> Add Event <i class="fas fa-plus-circle ml-2"></i> </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($events as $item)
                                        <tr>
                                            ...
                                            <td>{{$item->date}}</td>
                                            <td>
                                                <img src="{{asset('uploads/events/'.$item->image)}}" style="max-width: 100px" alt="">
                                            </td>
                                            <td>
                                                <div class="icons d-flex">
                                                    <a href="{{route('cms.events.show', $item->id)}}">
                                                        <div class="view text-info mx-2 cursor-pointer">
                                                            <i class="fas fa-eye"></i>
                                                        </div>
                                                    </a>
                                                    <a href="{{route('cms.events.edit', $item->id)}}">
                                                        <div class="edit text-primary mx-2 cursor-pointer">
                                                            <i class="fas fa-edit"></i>
                                                        </div>
                                                    </a>
                                                    <form action="{{route('cms.events.destroy', $item->id)}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
