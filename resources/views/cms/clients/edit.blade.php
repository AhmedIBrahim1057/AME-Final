    ...
    <section class="content px-3">
        <div class="row">
          <div class="col-md-12">
            ...
            <form action="{{ route('cms.clients.update', $client) }}" method="post" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                        ...
                        <div class="col-md-8">
                          <div class="form-group">
                              ...
                              <select class="custom-select" id="exampleSelectBorder" name="type" required>
                                <option value="1" {{ $client->type == 1 ? 'selected' : ''  }}>Racking & Shop Fitting</option>
                                <option value="2" {{ $client->type == 2 ? 'selected' : ''  }}>Scaffolding Framework</option>
                              </select>
                          </div>
                        </div>
                        <div class="col-md-8 pt-4">
                            <label for="">Name</label>
                            <input type="text" required name="name" class="form-control" placeholder="Enter client name" value="{{ $client->name }}">
                        </div>
                        <div class="col-md-8 pt-4">
                            <label for="">Image</label>
                            <div class="input-group cursor-pointer">
                                <div class="custom-file">
                                  <input type="file" name="image" class="custom-file-input" id="exampleInputFile" value="{{ $client->image }}" />
                                  <label class="custom-file-label" for="exampleInputFile">{{ $client->image }}</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8 pt-4">
                            <label for="">URL</label>
                            <input type="text" required name="url" class="form-control" placeholder="Enter client url" value="{{ $client->url }}">
                        </div>
                        {{-- <div class="col-md-8 pt-4">
