            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('cms.products.index')}}">Products</a>
                        </li>
                        ...
                        <div class="col-md-8">
                          <div class="form-group">
                              ...
                              <select class="custom-select" id="exampleSelectBorder" name="type" required>
                                <option value="1" {{ $product->type == 1 ? 'selected' : ''  }}>Racking & Shop Fitting</option>
                                <option value="2" {{ $product->type == 2 ? 'selected' : ''  }}>Scaffolding Framework</option>
                              </select>
                          </div>
                        </div>
                        <div class="col-md-8 pt-4">
                            <label for="">Title</label>
                            <input type="text" required name="title" class="form-control" placeholder="Enter Title" value="{{ $product->title }}">
                        </div>
                        <div class="col-md-8 pt-4">
                        ...
                        <div class="col-md-8 pt-4">
                            ...
                            <div class="form-group">
                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                    <input type="text" name="date" class="form-control datetimepicker-input" data-target="#reservationdate" value="{{ $product->date }}" />
...
<script>
  $(function () {
    ...
    $('.my-colorpicker2').on('colorpickerChange', function(product) {
      $('.my-colorpicker2 .fa-square').css('color', product.color.toString());
    })
