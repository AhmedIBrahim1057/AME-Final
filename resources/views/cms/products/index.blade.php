                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{route('cms.products.create')}}" class="btn btn-primary float-right"> Add Product <i class="fas fa-plus-circle ml-2"></i> </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($products as $item)
                                        <tr>
                                            ...
                                            <td>{{$item->date}}</td>
                                            <td>
                                                <img src="{{asset('uploads/products/'.$item->image)}}" style="max-width: 100px" alt="">
                                            </td>
                                            <td>
                                                <div class="icons d-flex">
                                                    <a href="{{route('cms.products.show', $item->id)}}">
                                                        <div class="view text-info mx-2 cursor-pointer">
                                                            <i class="fas fa-eye"></i>
                                                        </div>
                                                    </a>
                                                    <a href="{{route('cms.products.edit', $item->id)}}">
                                                        <div class="edit text-primary mx-2 cursor-pointer">
                                                            <i class="fas fa-edit"></i>
                                                        </div>
                                                    </a>
                                                    <form action="{{route('cms.products.destroy', $item->id)}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
