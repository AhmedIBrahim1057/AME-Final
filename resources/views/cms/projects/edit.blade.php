    ...
    <section class="content px-3">
        <div class="row">
          <div class="col-md-12">
            ...
            <form action="{{ route('cms.projects.update', $project) }}" method="post" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                        ...
                        <div class="col-md-8">
                          <div class="form-group">
                              ...
                              <select class="custom-select" id="exampleSelectBorder" name="type" required>
                                <option value="1" {{ $project->type == 1 ? 'selected' : ''  }}>Racking & Shop Fitting</option>
                                <option value="2" {{ $project->type == 2 ? 'selected' : ''  }}>Scaffolding Framework</option>
                              </select>
                          </div>
                        </div>
                        <div class="col-md-8 pt-4">
                            <label for="">Title</label>
                            <input type="text" required name="title" class="form-control" placeholder="Enter Title" value="{{ $project->title }}">
                        </div>
                        <div class="col-md-8 pt-4">
                            <label for="">Image</label>
                            <div class="input-group cursor-pointer">
                                <div class="custom-file">
                                  <input type="file" name="image" class="custom-file-input" id="exampleInputFile" value="{{ $project->image }}" />
                                  <label class="custom-file-label" for="exampleInputFile">{{ $project->image }}</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8 pt-4">
                            ...
                            <div class="form-group">
                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                    <input type="text" name="date" class="form-control datetimepicker-input" data-target="#reservationdate" value="{{ $project->date }}" />
